...
Car.csv
Docker image:
docker pull viktar99999/cars_1-ubuntu-python310:1.0
docker run -it viktar99999/cars_1-ubuntu-python310:1.0
exit
# Command for close container.
docker rm container_id
docker rmi viktar99999/cars_1-ubuntu-python310:1.0
